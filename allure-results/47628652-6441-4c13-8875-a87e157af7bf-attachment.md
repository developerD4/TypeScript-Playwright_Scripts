...
- Name: Allure-reporting\02-allure-steps-attachments-labels.spec.ts >> OrangeHRM login with readable Allure steps
- Location: tests\Allure-reporting\02-allure-steps-attachments-labels.spec.ts:10:5
