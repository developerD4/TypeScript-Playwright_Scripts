...
- Name: Allure-reporting\02-allure-steps-attachments-labels.spec.ts >> attach useful OrangeHRM test data
- Location: tests\Allure-reporting\02-allure-steps-attachments-labels.spec.ts:36:5
...
> 37 |   await page.goto('/web/index.php/auth/login');
  ...
  67 | 
  68 |   await page.goto('/web/index.php/auth/login');
  69 | 
